...
/**
 * The result produced by the {@link NotificationRuleEngine}. It indicates whether a notification
 * should be sent to a recipient or whether the chart should be updated silently, and, when a
 * notification is warranted, the priority it should carry.
 */
